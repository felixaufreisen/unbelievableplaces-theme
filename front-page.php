...
<main id="main" class="container">
  ...
  <h5 class="lines">Worüber ich schon geschrieben habe</h5>
  <?php do_action( 'get_unbelievable_map', '50.1', '8.7', '3.6' ) ?>

  <h5 class="lines">Reisezählwerk</h5>
  ...
  <h5 class="lines">Neuste Beiträge</h5>
